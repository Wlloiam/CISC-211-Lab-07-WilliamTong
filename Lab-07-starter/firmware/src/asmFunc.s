...
.endif
    ...
    Case_For_B:
	AND r6,r10,r2		//using logical operator AND to get the value of B, unpacking
	LSL r3,r6,16		//shifting the B value to the left 16 times to check the sign value, and stored it in r3
	ADDS r3,r3,0		//adding 0 to r3, and store it in r3, then update the flags to check the sign value of B
